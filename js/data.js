...
export const grafyDuveraMini = {
  names: ["Vzdělání", "Příjmy", "Kraj", "Věk při vstupu (2004)"],
  cat: [2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018],
  vzdelani: {
    zs: [35.4, 26.9, 30.1, 36.3, 33.1, 26.0, 26.1, 25.3, 27.2, 33.0, 22.0, 32.6, 33.0],
    ss: [28.5, 25.1, 36.7, 34.3, 32.6, 22.3, 18.5, 19.1, 22.0, 24.9, 22.9, 22.9, 27.9],
    mat: [42.3, 39.0, 43.9, 45.2, 36.5, 31.6, 27.8, 28.7, 31.8, 36.3, 26.7, 34.2, 40.5],
    vs: [50.9, 47.7, 57.1, 50.0, 46.3, 45.2, 34.8, 34.2, 35.8, 36.4, 34.0, 43.9, 50.9],
  },
  prijmy: {
    vysoke: [50.0, 52.9, 58.5, 53.8, 45.9, 44.2, 36.2, 30.3, 37.9, 36.6, 39.3, 40.5, 53.2],
    stredni: [30.9, 29.6, 40.4, 39.8, 30.2, 25.6, 23.9, 23.2, 31.7, 36.6, 20.8, 31.9, 39.9],
    nizke: [29.2, 20.7, 30.7, 25.2, 31.1, 18.1, 16.5, 17.1, 15.7, 23.9, 11.1, 22.9, 26.7],
  },
  regiony: {
    praha: [37.9, 35.0, 37.9, 47.6, 43.8, 35.8, 25.0, 26.4, 32.9, 34.4, 28.2, 33.3, 44.5],
    kv: [40.5, 31.5, 37.8, 43.2, 26.9, 19.5, 31.4, 29.6, 29.0, 35.2, 18.3, 23.5, 35.1],
    ms: [42.6, 29.0, 46.0, 42.7, 42.0, 28.6, 23.8, 31.2, 32.5, 33.1, 27.0, 32.7, 37.1],
    ost: [33.0, 31.5, 39.8, 35.1, 31.9, 27.3, 23.6, 23.1, 24.7, 29.3, 25.6, 31.9, 32.6],
  },
  vek: {
    do14: [61.0, 53.8, 57.6, 57.7, 54.5, 40.7, 43.0, 42.6, 36.2, 48.3, 30.8, 43.9, 44.8],
    do29: [42.3, 43.9, 51.7, 46.4, 41.9, 37.2, 26.5, 31.4, 34.6, 36.3, 28.6, 35.4, 40.7],
    do44: [39.2, 34.2, 41.1, 42.0, 30.7, 23.8, 23.4, 21.2, 27.1, 28.7, 25.6, 28.8, 32.7],
    do59: [29.7, 20.8, 33.2, 31.9, 32.0, 21.0, 18.1, 17.4, 21.3, 23.1, 20.3, 22.3, 28.5],
    nad60: [28.1, 23.3, 23.5, 26.5, 24.0, 22.2, 17.7, 20.2, 20.0, 22.5, 22.1, 25.0, 37.0],
  },
};
