...
export const questions = [
  "Nakolik je podle Vás členství v EU prospěšné či škodlivé <b>pro Česko jako celek?</b>",
  "Nakolik je podle Vás členství v EU prospěšné či škodlivé <b>pro Vás osobně?</b>",
  "Nakolik je podle Vás členství v EU prospěšné či škodlivé <b>pro život v Česku za 20 let?</b>",
  "Souhlasíte s tím, že členství Česka v EU vede k <b>lepšímu právnímu státu</b> (lepší zákony, vymahatelnost práva, spravedlivost soudů, apod.)?",
  "Souhlasíte s tím, že členství Česka v EU vede k <b>lepšímu stavu politiky v ČR</b> (méně korupce, lepší politická kultura, apod.)?",
  "Souhlasíte s tím, že členství Česka v EU vede k <b>přibližování mezd západním zemím?</b>",
  "Souhlasíte s tím, že členství Česka v EU vede k <b>vyššímu růstu české ekonomiky?</b>",
  "Které výhody členství v Evropské unii platí pro Vás osobně? Díky Evropské unii <b>mám větší šance najít si práci?</b>",
  ...
  "Jak byste případně v referendu hlasoval(a) o setrvání Česka v EU?",
  "Souhlasíte s tím, aby byla za měnu České republiky přijata společná evropská měna?",
  "Do jaké míry souhlasíte s tím, že <b>EU příliš zasahuje do vnitřních záležitostí ČR</b>? (Má příliš velký vliv na českou politiku a omezuje Česko evropskými zákony a regulací.)",
  "Do jaké míry souhlasíte s tím, že z <b>evropské integrace těží velké státy, které rozhodují na úkor malých států (jako Česká republika)</b>, jejichž zájmy neberou v potaz.",
  "Do jaké míry souhlasíte s tím, že <b>EU udělala hodně pro to, aby se v ČR zvýšila životní úroveň a přiblížila se tak životní úrovni v zemích Západní Evropy?</b>",
  "Do jaké míry souhlasíte s tím, že <b>EU nutí Českou republiku přijímat zbytečné a neefektivní zákony?</b>",
  "Nakolik souhlasíte s tím, že <b>silný vůdce je důležitý pro Českou republiku, i když nebude vždy jednat v souladu se zavedenými pravidly?</b>",
  "Nakolik souhlasíte s tím, že <b>obyčejný člověk by v politice reprezentoval mé zájmy lépe nežli profesionální politik?</b>",
  "Nakolik souhlasíte s tím, že <b>imigranti mohou ohrožovat českou ekonomiku a sociální stát?</b>",
